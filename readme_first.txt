...
Internally, a Font is divided in to blocks where each block references a unicode codepoint range.
Each font is intended for rendered either as Mono fixed width or Proportional space, but this may be ignored at runtime through a Print flag.
