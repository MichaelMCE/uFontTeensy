 ...
 * href="https://github.com/adafruit/Adafruit-GFX-Library"> GFX</a>
...
SSD1306::SSD1306 (uint8_t w, uint8_t h, TwoWire *twi, int8_t rst_pin, uint32_t clkDuring, uint32_t clkAfter)
    : spi(NULL), wire(twi ? twi : &Wire), buffer(NULL),
...
void SSD1306::drawPixel (int16_t x, int16_t y)
{
