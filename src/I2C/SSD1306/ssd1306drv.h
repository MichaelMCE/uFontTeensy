...
/*
	...
	This is the Adafruit driver but without the bloat
...
#pragma once
#ifndef _SSD1306DRV_H_
#define _SSD1306DRV_H_
...
class SSD1306 {
public:
  SSD1306 (uint8_t w, uint8_t h, TwoWire *twi = &Wire, int8_t rst_pin = -1, uint32_t clkDuring = 800000UL, uint32_t clkAfter = 100000UL);
